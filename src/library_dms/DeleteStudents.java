    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sid=jTextField1.getText();
            if(sid==null||sid.trim().equals("")){
                JOptionPane.showMessageDialog(DeleteStudents.this,"ID can't be blank");
            }else{
            int id=Integer.parseInt(sid);
                int i=StudentDao.delete(id);
                if(i>0){
                    JOptionPane.showMessageDialog(DeleteStudents.this,"Record deleted successfully!");
                    this.dispose();
                    new LibrarianSuccess().setVisible(true);
                }else{
                    JOptionPane.showMessageDialog(DeleteStudents.this,"Student does not exit!");
                }
            }
